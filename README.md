# Automatic-Image-based-Invoice-Logger
This project is used to record essential invoice/receipt information, categorize spending, and make a record in Google Sheets by just uploading the invoice/receipt image.
